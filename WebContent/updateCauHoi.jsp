            ...
            <div class="col-md-12">
                ...
                <div class="container-fluid">
                           <%                       
								...
								String sql = "SELECT * FROM  CauHoi WHERE IdCauHoi='" +request.getParameter("param1")+"'";			
								ResultSet rec = s.executeQuery(sql);							
							%>
                             <%while((rec!=null) && (rec.next())) {%>
                             
                                <!-- Modal body -->
                                 <form class="form-horizontal" action ="UpdateCauHoiServlet" >
                                 <div class="modal-body">
                                    <div class="form-group">
                                        <label>Mã Câu hỏi  </label>
                                           
                                        <input type="text" name ="idCauHoi" class="form-control" value="<%=request.getParameter("param1")%>" >
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Mã Môn Học</label>
                                        <input type="text" name ="maMonHoc" class="form-control" value="<%=request.getParameter("param2")%>">
                                    </div>
                                    <div class="form-group">
                                        <label>Câu Hỏi</label>
                                        <input type="text" name ="cauHoi"  class="form-control" value="<%=rec.getString("CauHoi")%>" >
                                    </div>
                                    <div class="form-group">
                                        <label>Đáp Án A:</label>
                                        <input type="text" name ="dapAn1"  class="form-control" value="<%=request.getParameter("param4")%>"  >
                                    </div>
                                    <div class="form-group">
                                        <label>Đáp Án B:</label>
                                        <input type="text" name ="dapAn2"  class="form-control" value="<%=request.getParameter("param5")%>" >
                                    </div>
                                    <div class="form-group">
                                        <label>Đáp Án C</label>
                                        <input type="text" name ="dapAn3"  class="form-control" value="<%=request.getParameter("param6")%>"  >
                                    </div>
                                    <div class="form-group">
                                        <label>Đáp Án D</label>
                                        <input type="text" name ="dapAn4"  class="form-control" value="<%=request.getParameter("param7")%>" >
                                    </div>
                                    <div class="form-group">
                                        <label>Đáp Án Đúng</label>
                                        <input type="text" name ="dapAnDung"  class="form-control" value="<%=request.getParameter("param8")%>"  >
                                    </div>                                 
                                    <div class="form-group">        
