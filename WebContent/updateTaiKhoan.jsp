                                ...
                                <!-- Modal body -->
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name ="p_assword" class="form-control" value="<%=request.getParameter("param2")%>" placeholder="Nhập vào mật khẩu" type="password">
                                    </div>
                                    <div class="form-group">
                                        <label>Họ tên</label>
                                        <input type="text" name ="hoTen"  class="form-control" value="<%=request.getParameter("param3")%>" placeholder="Nhập vào họ tên">
                                    </div>
                                    <div class="form-group">
                                        <label>GioiTinh</label>
                                        <input type="text" name ="gioiTinh"  class="form-control" value="<%=request.getParameter("param4")%>"  placeholder="Nhập vào Giới Tính">
                                    </div>
                                    <div class="form-group">
                                        <label>NgaySinh</label>
                                        <input type="text" name ="ngaySinh"  class="form-control" value="<%=request.getParameter("param5")%>"  placeholder="Nhập vào Ngày Sinh">
                                    </div>
                                    <div class="form-group">
                                        <label>DiaChi</label>
                                        <input type="text" name ="diaChi"  class="form-control" value="<%=request.getParameter("param6")%>"  placeholder="Nhập vào Địa Chí">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="">Loại Người Dùng: </label>
                                        <select class="form-control" type="text" value="<%=request.getParameter("param7")%>" name ="idType" >
