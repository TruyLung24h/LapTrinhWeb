                ...
                <div class="col-md-12">
                    ...
                    <FORM >
                        ...
                        <!-- kết thúc  -->
                         ...
                         %>
                         <from action="TrangLamBai.jsp" method="post">
                        <div style="background-color:Aqua;">
                            <label for="" style="color:red;"><%=rec.getString("cauHoi")%></label><br><br>
                            <input type="radio" name="dapAn" id ="dapAn" value="<%=rec.getString("dapAn1")%>" checked><%=rec.getString("dapAn1")%><br><br>
                            <input type="radio" name="dapAn" id ="dapAn"  value="<%=rec.getString("dapAn2")%>"><%=rec.getString("dapAn2")%><br><br>
                            <input type="radio" name="dapAn" id ="dapAn"  value="<%=rec.getString("dapAn3")%>"><%=rec.getString("dapAn3")%><br><br>
                            <input type="radio" name="dapAn" id ="dapAn"  value="<%=rec.getString("dapAn4")%>"><%=rec.getString("dapAn4")%><br><br>
                        </div>
                         <input TYPE=submit V/>
                        </from>
	                         <%                         
	                		 ...
	                		 String	Time_BatDau = "2019-4-1";  
	                		 String	Time_KetThuc= "2019-4-5";	                		
	                         pst.setString(1, IdDeThi);
	                         pst.setString(2, IdCauHoi);
	                         pst.setString(3, Username);
	                         pst.setInt(4,Time_GioiHanLamBai);
	                         pst.setString(5, Time_BatDau);
	                         pst.setString(6, Time_KetThuc);
                        ...
                        <div style="background-color:white;">
                            <label for="" style="color:red;"><%=rec.getString("cauHoi")%></label><br><br>
                            <input type="radio" name="<%=rec.getString("cauHoi")%>" value="<%=rec.getString("dapAn1")%>" checked><%=rec.getString("dapAn1")%><br><br>
                            <input type="radio" name="<%=rec.getString("cauHoi")%>" value="<%=rec.getString("dapAn2")%>"><%=rec.getString("dapAn2")%><br><br>
                            <input type="radio" name="<%=rec.getString("cauHoi")%>" value="<%=rec.getString("dapAn3")%>"><%=rec.getString("dapAn3")%><br><br>
                            <input type="radio" name="<%=rec.getString("cauHoi")%>" value="<%=rec.getString("dapAn4")%>"><%=rec.getString("dapAn4")%><br><br>
