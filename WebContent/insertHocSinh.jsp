                ...
                <div class="container-fluid">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane  in active" id="DanhSachNguoiDung">
							...
							<form name="frmSearch"  >							  
							    <tr>							      
							      <input name="txtKeyword" type="text" id="txtKeyword"  class="form-control" id="txtSearch" placeholder="Search for...">
                            ...
                            <div class="tblNguoiDung" id="tblNguoiDung">
                                <table class="table">
                                   ...
                                   <%while((rec!=null) && (rec.next())) {  
                                	   ...
                                	   String themURL="InsertChiTietLopHocServlet?maLop=" + request.getParameter("param1")
                                	...
                                	%>
										...
										<tr>																	
										    ...
										    <td>
								               <button class="form-control">  <a href="<%=themURL%>">Thêm</a></button> 
								            </td>
